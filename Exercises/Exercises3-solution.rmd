...
&= i^2 \cdot P_{i,i-1} + (i-1)^2 \cdot P_{i,i+1} + (i+1)^2 \cdot P_{i,i} - i^2 \\
&= - \frac{i}{N}(1 - \frac{i}{N}) \cdot i^2 + ((i+1)^2 + (i-1)^2) \cdot \frac{i}{N}(1 - \frac{i}{N}) \\
&= 2\frac{i}{N}(1 - \frac{i}{N})
\end{align*}

$Var[X(1) \mid X(0) = i] = 2\frac{i}{N}(1 - \frac{i}{N}),\ \forall t > 0$.
...
&= 2\frac{E_{X(t-1)}}{N}(1 - \frac{E_{X(t-1)}}{N}) - \frac{2}{N^2}Var[X(t-1)] + Var[X(t-1)] \\
&= 2\frac{E_{X(t-1)}}{N}(1 - \frac{E_{X(t-1)}}{N}) + (1-\frac{2}{N^2})Var[X(t-1)] \\
&= 2V_1 + (1-\frac{2}{N})Var[X(t-1)] 
\end{align*}
...
Given the expression of variance in b), we can show
\begin{align*}
\lim_{N\to \infty}Var[X(t)]
&= \lim_{N\to \infty} 2\frac{i}{N}(1 - \frac{i}{N})\frac{1 - (1 - \frac{2}{N^2})^t}{\frac{2}{N^2}} \\
&= (1 - \frac{2}{N^2})^{t-1}(V_1 - \frac{V_1}{\frac{2}{N^2}})
\end{align*}
...
$$
\lim_{r\to 1}\frac{1-r^{-1}}{1-r^{-N}} = \lim_{r\to 1}\frac{-\log(r)}{Nr^{-N-1}} = 0
$$

...
opts_chunk$set(comment=NA,tidy=TRUE,message=FALSE,warning=FALSE,echo=TRUE,cache=FALSE,fig.path='figure/minimal-', fig.align='center', fig.show='hold', fig.width=3.5, fig.height=3.5)
